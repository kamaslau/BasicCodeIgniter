...
<div id=content class=container>
	...
	<?php if ( !empty($operation) ): ?>
		...
		<li class="col-xs-12 col-sm-6 col-sm-3"><a class="btn btn-default btn-lg" href="<?php echo base_url($this->class_name.'/create') ?>">继续创建</a></li>
        <?php endif ?>
		
		<?php if ( in_array($operation, array('create', 'edit', 'edit_certain',)) ): ?>
