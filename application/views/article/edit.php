	...
	?>
		<fieldset>
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=category_id type=text value="<?php echo $item['category_id'] ?>" placeholder="分类ID" required>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=excerpt type=text value="<?php echo $item['excerpt'] ?>" placeholder="摘要（可留空）">
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<textarea id=ueditor name=content placeholder="详情" rows=5 required><?php echo $item['content'] ?></textarea>
